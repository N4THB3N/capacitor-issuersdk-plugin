...
export declare enum TokenServiceProvider {
    AMEX = "AMEX",
...
export interface IssuerGooglePay {
    ...
    containsToken(params: IContainsToken): Promise<IssuerGpApi<boolean | DefaultErrorApi>>;
    tokenize(params: ITokenizeGP): Promise<IssuerGpApi<IProvisioningResult | DefaultErrorApi>>;
    executeProvisioning(params: IProvisionByPushReceiptId): Promise<IssuerGpApi<IProvisioningResult | DefaultErrorApi>>;
    executeProvisioningOfEncryptedCard(params: IProvisionByEncryptedCard): Promise<IssuerGpApi<IProvisioningResult | DefaultErrorApi>>;
}
